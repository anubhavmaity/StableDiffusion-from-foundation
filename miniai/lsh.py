...
# %% ../nbs/02_locality_sensitive_hashing_lsh.ipynb 5
torch.manual_seed(42)
torch.set_printoptions(precision=3, linewidth=140, sci_mode=False)

# %% ../nbs/02_locality_sensitive_hashing_lsh.ipynb 7
class FastLSH:
...
# %% ../nbs/02_locality_sensitive_hashing_lsh.ipynb 12
@patch
def hashing(self:FastLSH, query): 
    return (((query[:, None, None]) * self.hash_table).sum(-1) >= 0).long()

# %% ../nbs/02_locality_sensitive_hashing_lsh.ipynb 30
@patch
