...
# %% auto 0
__all__ = ['act_gr', 'summary', 'CapturePreds', 'rand_erase', 'RandErase', 'rand_copy', 'RandCopy']
...
# %% ../nbs/lectures/14_augment.ipynb 58
...
# %% ../nbs/lectures/14_augment.ipynb 61
...
# %% ../nbs/lectures/14_augment.ipynb 63
...
# %% ../nbs/lectures/14_augment.ipynb 75
...
# %% ../nbs/lectures/14_augment.ipynb 77
def rand_copy(x, pct=0.2, max_num = 4):
    num = random.randint(0, max_num)
    for i in range(num): _rand_copy1(x, pct)
    return x

# %% ../nbs/lectures/14_augment.ipynb 79
